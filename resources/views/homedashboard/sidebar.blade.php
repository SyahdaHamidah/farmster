<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        @if (auth()->user()->role == "admin")
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-edit"></i> <span>Peternakan</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="/farmadmin">Data Peternakan</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
        ...
        <li class="menu-header">Dashboard</li>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-edit"></i> <span>Post</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="/postuser">List Post</a></li>
                    <li><a class="nav-link" href="{{ route('post.show_delete') }}">Trashed Post</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-edit"></i> <span>Peternakan</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="/farmindex">Data Peternakan</a></li>
                </ul>
            </li>
        </ul>
        @endif
